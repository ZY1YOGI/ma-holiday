<x-layout title="Home" description="Home description" keywords="Home keywords">
    ...
    <main class="container">
                                    ...
                                    <div class="p-4 sm:pt-8 sm:px-10">
                                        <div class="relative flex items-center text-neutral-900 dark:text-neutral-300">
                                            <button class="slide-trip-prev w-11 h-11 text-xl mr-[6px] bg-white dark:bg-slate-800 border border-neutral-200 dark:border-neutral-6000 dark:hover:border-neutral-500 rounded-full flex items-center justify-center hover:border-neutral-300 focus:outline-none" title="Prev">
                                                < </button>
                                                    <button class="flex items-center justify-center text-xl bg-white border rounded-full slide-trip-next w-11 h-11 dark:bg-slate-800 border-neutral-200 dark:border-neutral-6000 dark:hover:border-neutral-500 hover:border-neutral-300 focus:outline-none" title="Next">
                                                        >
                                                    </button>
                                        </div>
                                    </div>
        ...
        <section class="relative py-10 px-2.5 overflow-hidden">
            <header class="space-y-3 text-center">
                ...
                <p class="px-1 text-xl font-semibold text-sky-900/80 dark:text-white/50">Many Trips for you can chooses the right trip from the ground</p>
            </header>
        ...
        <section class="container my-20 max-md:px-3">
            ...
            <div class="relative overflow-hidden" id="slide-gallery">
        ...
        {{-- <section class="container my-20 max-md:px-3">
            <header class="space-y-3 text-center">
                <h1 class="text-2xl font-medium text-blue-800 uppercase dark:text-blue-50">Join thousands of satisfied customers</h1>
                <p class="text-4xl font-semibold uppercase text-sky-950 dark:text-sky-500">Opinions about trips</p>
            </header>
            <div id="slide-customers" class="overflow-hidden">
                <div class="my-12 swiper-wrapper">
    ...
    <a href="https://www.facebook.com/messages/t/104678265041561" class="fixed bottom-5 bg-white rounded-full p-3.5 right-5 z-50 shadow" target="_blank">
