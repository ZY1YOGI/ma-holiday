<header class="top-0 w-full left-0 right-0 z-40 transition-all duration-500 relative border_gradient border-b-8" x-data={}>
    <div class="container py-3 relative flex justify-between items-center space-x-4 lg:space-x-8">
        <div class="flex justify-start flex-grow items-center lg:space-x-4 2xl:space-x-14">
            <a class="relative" title="Marsa Alam Holiday" href="{{ route('home') }}">
