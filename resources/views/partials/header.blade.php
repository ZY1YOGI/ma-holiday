<div class="nc-Header nc-will-change-top sticky top-0 w-full left-0 right-0 z-40 transition-all">
            ...
            <div class="flex justify-start flex-grow items-center space-x-4 sm:space-x-10 2xl:space-x-14">
                ...
                <ul class="nc-Navigation hidden lg:flex lg:flex-wrap lg:items-center lg:space-x-1 relative">
                    <li class="menu-item menu-dropdown relative">
                        <a aria-current="page" class="inline-flex items-center text-sm xl:text-base font-normal text-neutral-700 dark:text-neutral-300 py-2 px-4 xl:px-5 rounded-full hover:text-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:hover:text-neutral-200 !font-semibold !text-neutral-900 bg-neutral-100 dark:bg-neutral-800 dark:!text-neutral-100" rel="noopener noreferrer" id="headlessui-popover-button-1" aria-expanded="false" href="/ncmaz/">Home</a>
                    </li>
                    <li class="menu-item menu-megamenu">
                        <a class="inline-flex items-center text-sm xl:text-base font-normal text-neutral-700 dark:text-neutral-300 py-2 px-4 xl:px-5 rounded-full hover:text-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:hover:text-neutral-200" href="/ncmaz#">Five cols</a>
                    </li>
                    <li class="menu-item menu-megamenu relative">
                        <a class="inline-flex items-center text-sm xl:text-base font-normal text-neutral-700 dark:text-neutral-300 py-2 px-4 xl:px-5 rounded-full hover:text-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:hover:text-neutral-200" href="/ncmaz#">Fewer cols</a>
                    </li>
                    <li class="menu-item menu-dropdown relative">
                        <a class="inline-flex items-center text-sm xl:text-base font-normal text-neutral-700 dark:text-neutral-300 py-2 px-4 xl:px-5 rounded-full hover:text-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:hover:text-neutral-200" href="/ncmaz#">Templates</a>
                    </li>
                    <li class="menu-item menu-dropdown relative">
                        <a class="inline-flex items-center text-sm xl:text-base font-normal text-neutral-700 dark:text-neutral-300 py-2 px-4 xl:px-5 rounded-full hover:text-neutral-900 hover:bg-neutral-100 dark:hover:bg-neutral-800 dark:hover:text-neutral-200" href="/ncmaz#">Other pages</a>
                    </li>
                </ul>
            </div>
